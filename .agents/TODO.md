# Visual Assets — To Add Later

All copy and layout is complete without these, but adding them will
significantly elevate the visual quality. No design work needed — just
drop the files in and wire them up.
...
- [ ] `/demos/dashboard` — optional thumbnail for the home-page preview card.
