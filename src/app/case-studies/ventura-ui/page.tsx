...
export default function VenturaUIPage() {
  return (
    <CaseStudyLayout>
      ...
      <ul>
        <li>All variants and states (default, hover, focus, active, disabled, error, loading)</li>
      ...
      <p>
        I set up a monorepo with Turborepo so the design system package could
        be versioned independently and consumed by all portals. CI enforced that
      ...
      <ul>
        ...
        <li>Duplicate component code eliminated — one Button, one source of truth</li>
        <li>New engineer onboarding time reduced — consistent patterns across squads</li>
