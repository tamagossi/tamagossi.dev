...
export default function TeamRestructuringPage() {
  return (
    <CaseStudyLayout>
      <h1 className="mb-2">Frontend Team Restructuring & Standardization</h1>
      <p className="mb-8">
      ...
      <p>
        When I stepped into the Chapter Lead role, the frontend team had grown
        fast but without shared standards. Each squad had its own way of doing
        code reviews, testing (or not testing), and structuring components.
        Knowledge was siloed — what one squad learned stayed in that squad. Bug
        rates were high (100%+ regression rate — meaning every release
        introduced at least one regression). Developers blamed each other when
        things broke. Morale was declining.
      </p>

      <h2 className="mt-10">Approach & Decisions</h2>
      <p>I focused on three pillars: standards, culture, and growth.</p>
      <ul>
        <li>
      ...
      <ul>
        <li>
          Week 1–2: Introduced PR checklist + review SLA in team retrospective
        </li>
        <li>Week 3–4: Started regression test rule, paired on first 5 tests</li>
        <li>
          Month 2: Launched mentoring rotation, set up documentation dashboard
          in Notion
        </li>
        <li>
          Month 3: Created custom Copilot commands for automated PR descriptions
        </li>
      ...
      <ul>
        <li>
          Bug regression rate dropped from 100%+ to 70% (and still improving)
        </li>
        <li>
          PR review turnaround: from &ldquo;whenever&rdquo; to under 24 hours
        </li>
        <li>3 junior engineers reached independent productivity in 3 months</li>
        <li>
          Cross-squad knowledge sharing became the norm, not the exception
        </li>
        <li>
          Developer blame culture replaced with ownership and psychological
          safety
        </li>
      </ul>
      ...
      <p>
        If starting again, I would introduce the documentation dashboard earlier
        — it became the single source of truth that made standards discoverable.
        Waiting until month 3 meant 3 months of tribal knowledge that could have
        been written down.
      </p>
    </CaseStudyLayout>
  );
